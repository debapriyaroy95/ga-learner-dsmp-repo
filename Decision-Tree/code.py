...
plt.hist(fully_paid,color ='maroon',width = 0.4) 
...
# Code starts here
dot_data= export_graphviz(p_tree.best_estimator_, out_file=None,feature_names=X.columns, filled = True , class_names=['loan_paid_back_yes','loan_paid_back_no'])
